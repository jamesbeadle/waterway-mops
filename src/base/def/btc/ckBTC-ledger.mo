...
module {
    ...
    public type Result_1 = { #Ok : Nat; #Err : TransferError };
    public type Result_2 = { #Ok : ConsentInfo; #Err : Icrc21Error };
    public type Result_3 = { #Ok : Nat; #Err : ApproveError };
    public type Result_4 = { #Ok : Nat; #Err : TransferFromError };
    ...
    public type Interface = actor {
        ...
        icrc1_transfer : shared TransferArg -> async Result_1;
        icrc21_canister_call_consent_message : shared ConsentMessageRequest -> async Result_2;
        icrc2_allowance : shared query AllowanceArgs -> async Allowance_1;
        icrc2_approve : shared ApproveArgs -> async Result_3;
        icrc2_transfer_from : shared TransferFromArgs -> async Result_4;
